...
def build_risk_context_from_signals(
    *,
    ...
    The score is intentionally conservative and bounded:
    - Operational risk increases with open boundaries, breaker trips, failures.
    - Compliance/security baseline remains low by default for this server.
    - Cache misses can contribute a small operational signal.
    """
    safe_cache_hit_rate = (
