...
3. **[GitHub Issues](https://github.com/<OWNER>/<REPO>/issues)** - Bug reports and feature requests
4. **[GitHub Discussions](https://github.com/<OWNER>/<REPO>/discussions)** - Community support
