...
2. **GitHub Issues**: [Report bugs and issues](https://github.com/<OWNER>/<REPO>/issues)
3. **GitHub Discussions**: [Ask questions and get help](https://github.com/<OWNER>/<REPO>/discussions)
