...
1. **Fork and Clone**
   ...
   cd finos-mcp-server
   git remote add upstream https://github.com/finos/aigf-mcp-server.git
   ```
...
1. Create a [Security Advisory](https://github.com/finos/aigf-mcp-server/security/advisories) for responsible disclosure
